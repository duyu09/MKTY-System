<!--
- 文件描述：明康慧医MKTY智慧医疗系统后台管理系统 页面侧边栏
...
<script>
import { HomeFilled, User, Document, Collection, ChatDotRound, Message, ChatLineRound, List } from '@element-plus/icons-vue'
...
document.title = 'MKTY智慧医疗系统后台管理系统';
</script>
